...
header = ['ID', 'Data', 'Karmienie', 'Suplementacja', 'Żywność uzupełniająca']
# pobranie danych z bazy
data_list = conn.execute("SELECT id, date, fodder, supplementation, complementary_foods FROM schedule").fetchall()
