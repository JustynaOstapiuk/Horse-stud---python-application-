...
header = ['ID', 'Imię konia', 'Imię matki', 'Imię ojca', 'Rasa', 'Data urodzenia', 'Płeć', 'ID właściciela']
# pobranie danych z bazy
data_list = conn.execute("SELECT id, name, mother, father, race, birth, sex, owner_id FROM horse").fetchall()
